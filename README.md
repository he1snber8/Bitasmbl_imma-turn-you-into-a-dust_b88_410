...
```bash
bitasmbl pull --repoUrl https://github.com/he1snber8/Bitasmbl_imma-turn-you-into-a-dust_b88_410 --appId 410 --repoId 234
```

## 3) Enter into the main directory and start coding!

```bash
cd Bitasmbl_imma-turn-you-into-a-dust_b88_410
```
